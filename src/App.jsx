          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleAddRule} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div><label className="block text-sm font-medium text-slate-600 mb-2">เครื่องหมาย</label><select value={newRule.operator} onChange={(e) => setNewRule({...newRule, operator: e.target.value})} className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-emerald-500 focus:outline-none text-sm"><option value=">">มากกว่า</option><option value="<">น้อยกว่า</option></select></div>
        ...
        <div className="flex-1 overflow-auto p-4 lg:p-8">
          ...
          {activeTab === 'dashboard' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6"><Card title="อุณหภูมิอากาศ" value={sensorData.airTemp} unit="°C" icon={Thermometer} color="#f43f5e" subValue="DHT11 Sensor" /><Card title="ความชื้นอากาศ" value={sensorData.airHum} unit="%" icon={Droplets} color="#3b82f6" subValue="DHT11 Sensor" /></div>
